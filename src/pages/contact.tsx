    ...
    <div>
      ...
      <main className="px-6 sm:px-8 md:px-12 py-12 max-w-xl mx-auto">
        ...
        <section className="mt-8 grid gap-3">
          <a
            href="mailto:hovsepbabayan55@gmail.com"
            className="card flex items-center gap-3 hover:opacity-90 transition-opacity"
          >
            <span
              aria-hidden
              className="h-8 w-8 grid place-items-center rounded-full bg-foreground text-background"
            >
              @
            </span>
            <div>
          ...
          <a
            href="https://www.linkedin.com/in/hovsep-babayan-50475528a/?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app"
            target="_blank"
            rel="noreferrer"
            className="card flex items-center gap-3 hover:opacity-90 transition-opacity"
          >
